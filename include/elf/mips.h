...
START_RELOC_NUMBERS (elf_mips_reloc_type)
  ...
  /* N64 RSP relocations.  */
  RELOC_NUMBER (R_MIPS_RSP70, 66)
  RELOC_NUMBER (R_MIPS_RSP71, 67)
  RELOC_NUMBER (R_MIPS_RSP72, 68)
  RELOC_NUMBER (R_MIPS_RSP73, 69)
  RELOC_NUMBER (R_MIPS_RSP74, 70)
  RELOC_NUMBER (R_MIPS_RSP16, 71)
...
#define E_MIPS_MACH_RSP		0x008f0000
